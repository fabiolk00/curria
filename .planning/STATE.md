...
- Quick 260504-0rx: terms page now uses the standard public header and dynamic current month/year last-updated text.

## Accumulated Context

### Roadmap Evolution

- Phase 111 added: Refatorar job-targeting matcher para LLM source-of-truth sem catalogo.
