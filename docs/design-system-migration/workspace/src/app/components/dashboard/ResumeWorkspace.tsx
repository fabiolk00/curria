...
export function ResumeWorkspace({
  ...
  return (
    <>
      <div className="grid min-h-[calc(100vh-4rem)] gap-6 p-4 lg:grid-cols-[minmax(0,1.25fr)_420px] lg:p-6 items-start">
        <div className="overflow-hidden rounded-xl border border-border bg-background relative h-[calc(100vh-6rem)]">
          <ChatInterface
            sessionId={sessionId}
            userName={userName}
            ...
            onAgentTurnCompleted={(payload) => {
              setSessionId(payload.sessionId || "demo_session")
              void refreshWorkspace(payload.sessionId || "demo_session")
            }}
          />
        </div>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Esta área reflete o estado canônico atual da sessão.
              </CardDescription>
            </CardHeader>
              ...
              {workspace ? (
                <>
                  ...
                  <div className="grid gap-3 sm:grid-cols-3">
                    <button
                      type="button"
                      className="rounded-lg border border-border p-4 text-left hover:bg-muted/50 transition-colors"
                      disabled={isBusy}
                      onClick={() => openManualEdit("experience")}
                    >
                      <p className="text-xs uppercase text-muted-foreground">Experiência</p>
                      <p className="mt-1 text-lg font-semibold">
                        {workspace.session.cvState.experience?.length || 0}
                      </p>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      <p className="text-xs uppercase text-muted-foreground">Educação</p>
                      <p className="mt-1 text-lg font-semibold">
                        {workspace.session.cvState.education?.length || 0}
                      </p>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      <p className="text-xs uppercase text-muted-foreground">Certificações</p>
                      <p className="mt-1 text-lg font-semibold">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Targets e ações</CardTitle>
              <CardDescription>
