...
export default function FinalCta() {
  return (
    <section className="py-24 bg-card border-y border-border/50 relative overflow-hidden">
      ...
      <div className="dark:absolute dark:inset-0 dark:opacity-[0.03] dark:pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, white 1px, transparent 0)', backgroundSize: '40px 40px' }} />
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="mt-12">
          <Button asChild size="lg" className="text-lg gap-3 h-14 px-8 font-semibold shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all">
            <Link to="/signup">
